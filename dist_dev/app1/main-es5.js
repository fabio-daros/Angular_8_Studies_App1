...
var Heart = /** @class */ (function () {
    function Heart(full, urlFullHeart, urlEmptyHeart) {
        if (urlFullHeart === void 0) { urlFullHeart = '/assets/heart_full.png'; }
        if (urlEmptyHeart === void 0) { urlEmptyHeart = '/assets/heart_empty.png'; }
        this.full = full;
    ...
    Heart.ctorParameters = function () { return [
        { type: Boolean },
        { type: String },
        { type: String }
    ]; };
